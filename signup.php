        ...
        <div class="form-wrap">
            <div class="inner-wrap">
                ...
                <label for="name" class="label">Full Name:</label><br>
                    <input type="text" class="fill" name="name"  placeholder="Enter Name" required><br>
                ...
                if(isset($_POST['submit'])){
                    ...
                    $logindetails = [];
                    $logindetails = "{" . $name . ',' . $user . ',' . $password . "}" . "/n";
                    $fileopen = fopen('crendential.txt', 'a+');
                    $file = file_get_contents('crendential.txt'); 
                   
                        if (strpos($file, $user)) { 
                            echo "Email Address Already Used" . $user;   
                        }
                         else if (fwrite($fileopen, $logindetails)){
                ...
                ?>
                <p>Please Click To <a href = "signin.php">SignIn</a></span></p>
                <div class="forgot">
